  ...
  return (
    <div className="mt-20 border-b border-neutral-700">
      <div className="text-center">
        <span className="bg-neutral-800 text-indigo-500 rounded-full w-fit h-8 text-sm font-medium px-4 py-1 uppercase block m-auto mb-20">
          Features
        </span>
          ...
          {features.map((item, idx) => (
            <div key={idx} className="w-full lg:w-1/3 sm:w-1/2">
              <div className="flex">
                ...
                <div>
                  <h5 className="mt-1 md-6 text-xl font-customFontKr">
                    {item.text}
                  </h5>
